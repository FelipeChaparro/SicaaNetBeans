					 ...
					 var cell4 = row.insertCell(2);
					    ...
					    for(var j=0; j<arti[i].autor.length; j++){
					     ...
					     //cell3.innerHTML ="Fecha";
					      ...
					      bt.className = "btn btn-danger"
					      bt.innerHTML = "Eliminar";
					      bt.setAttribute("onclick", "deleteRow(this,'tablaResearchArticulos')"); 
				    	...
				    	if(arti[i].tipo === "Book"){
							 ...
							 var cell4 = row.insertCell(2);
							   ...
							   //  cell3.innerHTML ="Fecha";
							      ...
							      bt.className = "btn btn-danger"
							      bt.innerHTML = "Eliminar";
							      bt.setAttribute("onclick", "deleteRow(this,'tablaResearchLibros')"); 
					   ...
					   tabla2.style.display = 'block';
								 ...
								 var cell4 = row.insertCell(2);
								    ...
								    for(var j=0; j<arti[i].autor.length; j++){
								     ...
								     //cell3.innerHTML ="Fecha";
								      ...
								      bt.className = "btn btn-danger"
								      bt.innerHTML = "Eliminar";
								      bt.setAttribute("onclick", "deleteRow(this,'tablaResearchCapitulos')"); 
					    ...
					    var tabla3 = document.getElementById("tablaResearchConferencia");
						   tabla3.style.display = 'block';
						    for(var i=0; i< arti.length; i++){
						    	if(arti[i].tipo === "Conference Paper"){
									 ...
									 var cell4 = row.insertCell(2);
									    ...
									    // cell3.innerHTML ="Fecha";
									      ...
									      bt.className = "btn btn-danger"
									      bt.innerHTML = "Eliminar";
									      bt.setAttribute("onclick", "deleteRow(this,'tablaResearchConferencia')"); 
